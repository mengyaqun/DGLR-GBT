...
imwrite(uint8(im),strcat('./15_Result/',Final_denoisng));
...
imwrite(uint8(x_inpaint_rgb),strcat('./15_Result/',Final_color_denoisng));
...
imwrite(uint8(im),strcat('./25_Result/',Final_denoisng));
...
imwrite(uint8(x_inpaint_rgb),strcat('./25_Result/',Final_color_denoisng));
